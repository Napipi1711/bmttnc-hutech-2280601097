    ...
    def call_api_encrypt(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                QMessageBox.information(self, "Success", "Encrypted Success")
            else:
                QMessageBox.warning(self, "Error", "Error calling API")
    ...
    def call_api_decrypt(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                QMessageBox.information(self, "Success", "Decrypted Success")  # Fixed
            else:
                QMessageBox.warning(self, "Error", "Error calling API")
        except Exception as e:
            QMessageBox.warning(self, "Error", str(e))  # Fixed indent
